...
<?php
   ...
   $url = 'http://212.189.207.119/bdb/retrieve/sensors';
...
<script>
  ...
  // var package_url = "http://212.189.207.119/bdb/boards"
   ...
   //            console.log(sensor_unit,sensor_name);
        console.log("Graph drawing triggered.");
           ...
           url ="http://212.189.207.119/bdb/sensors/"+resourceId+"/graph"
           console.log("url:"+url);
                   ...
                   plotOptions: {
                          series: {
                              ...
                              point: {
                                  events: {
                                      click: function () {
                                          location.href="http://212.189.207.119/bdb/verify?id="+this.unique;
                                      }
                                  }
                              }
                          }
