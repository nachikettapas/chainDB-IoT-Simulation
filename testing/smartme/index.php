                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12" >
                                        <dt>Legend:</dt>
                                        <dd><img src="img/red-dot.png" style="padding-bottom: 1em;"> #SmartME sensors</dd>
                                        <dd><img src="img/icon_pothole.png" style="padding-bottom: 1em;" width="30px"> #SmartME pothole</dd>
                                        <dd><img src="img/taxi_marker.png" style="padding-bottom: 1em;" width="30px"> #SmartME taxi </dd>
                                        <dd><img src="img/energy_marker.png" style="padding-bottom: 1em;" width="30px"> #SmartME Energy </dd>
                                        <dd><img src="img/park_marker.png" width="30px"> #SmartME Parking</dd>
                                        <dd><img src="img/lighting_marker.png" width="30px"> #SmartME Lighting</dd>
                                    </div>
                                </div>
                            </div>
                                <!-- /.box-body -->
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="pull-right">
                                <div class="form-group form-inline">
                                    <label>Data view:
                                    <select class="form-control" id="last_result">
                                        <?php
                                    ...
                                    | <b>
                                        <a href="/heatmap.php#mapdiv">
                                            <i class="fa fa-map-o"></i> HeatMap</a>
                                    </b>
                                </div>
...
<script>
	...
	var flag_first_load = true;
	    ...
	    //var jcall = JsonpCallv2(url_org_datasets, org, 150, "GetCKAN");
		    ...
		    if(v.organization != null) {
			    ...
			    //TO
			    //console.log(vv.name +"  "+JSON.stringify(vv));
			    ...
			    array_markers_taxi.push(marker);
            ...
            $.getJSON("./jsonp_call.php?parking=true").done(function(data) {
                   var t = JSON.parse(JSON.stringify(data));
                    ...
                    var link_to_graph = '<a class="list-group-item call_modal ' +
                                    ...
                                    ' id="' + resource_id + '" pack_name="smartpark" url="' + resource_id + '" sensor_type="free" sensor_unit="lots unit" href="#sensor_modal"><i class="fa fa-bar-chart"></i> View Stats </a>\n'
        ...
        function getParkingInfoMI(){
            
            var free, busy;

            $.getJSON("./jsonp_call.php?parking_mi=true").done(function(data) {
                   //var t = JSON.parse(data);
                    //console.log(data[0]);
                    
                    var resource_id = "d5d37bee-f2b4-47c9-ba69-0c277d0830c2";
		    var pack_name = "c9bb987a-d875-9cb4-620c-9e808ef6893d";
                    var link_to_graph = '<a class="list-group-item call_modal ' +
                                    ' bold" style="color:black; background:LightBlue" sensor-name="Free parking lots " '+
                                    ' id="' + resource_id + '" pack_name="'+pack_name+'" url="' + resource_id + '" sensor_type="free" sensor_unit="lots unit" href="#sensor_modal"><i class="fa fa-bar-chart"></i> View Stats </a>\n'

                   $('#parking_info_mi').html('<br><b>parking lot free: ' + data[0].free + "/" + 8 + "</b><br>" +
                        '<div>'+ link_to_graph +'</div>'
                   );
                }
            )
        ...
        function getLightingInfoMI(){
            
             $.getJSON("./jsonp_call.php?lighting_mi=true").done(function(data) {
                   //var t = JSON.parse(data);
                    //console.log(data);
                    
                    var resource_id = "9441735c-ba70-4f9c-981b-1bd6bb8090b7";
		    var pack_name = "smart_lighting";

                    var link_to_graph = '<a class="list-group-item call_modal ' +
                                    ' bold" style="color:black; background:LightBlue" sensor-name="Power consumption " '+
                                    ' id="' + resource_id + '" pack_name="'+pack_name+'" url="' + resource_id + '" sensor_type="watt" sensor_unit="W" href="#sensor_modal"><i class="fa fa-bar-chart"></i> View Stats </a>\n'

		   //FROM
		   /*
                   $('#lighting_info_mi').html('<br><b>lamp on: ' + data[0].lamps_on + "/" + 10 + "</b><br>" +
                        '<div>'+ link_to_graph +'</div>'
                   );
		   */
		   //TO
		   var turn_on_off = '<a class=list-group-item ' +
				    ' bold" style="color:black; background:LightBlue" test="ggg" data-toggle="modal" data-target="#lamp_modal">Turn ON/OFF lamp</a>\n';
		   $('#lighting_info_mi').html('<br><b>lamp on: ' + data[0].lamps_on + "/" + 10 + "</b><br>" +'<div>'+ link_to_graph +'</div><div>'+turn_on_off+'</div>');
                }
            )
